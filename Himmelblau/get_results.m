...
endvals(j, ii, 2, k) = (100171 - folders.output_ana.health(end, 4) - folders.output_ana.health(end, 5))./100171;
endvals(j, ii, 3, k) = folders.output_ana.health(end, 4);

endvals(j, ii, 4, k) = folders.output_ana.eval(end, 3);
